...
function getFylkeOptions() {
    let HTML = ``;
    const Fylker = ['Alle Fylker','Telemark & Vestfold','Akershus','Oslo','Vestland','Rogaland','Trøndelag','Innlandet','Agder','Østfold','Møre & Romdsdal', 'Buskerud','Nordland','Troms','Finnmark'];
